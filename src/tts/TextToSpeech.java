...
public class TextToSpeech {
	...
	public void SpeakGreeting(float gainValue,boolean daemon, boolean join){

		String[] greetings = {"hello", "hi"};

		Random rand = new Random();
		String randomGreet = greetings[rand.nextInt(greetings.length)];

		speak(randomGreet,gainValue,daemon,join);
